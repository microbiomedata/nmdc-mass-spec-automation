...
def extract_sample_info_from_filename(filename):
    ...
    # Example patterns to look for in pettridge_11_076c9980:
...
def main():
    ...
    config_path = Path("/Users/heal742/LOCAL/05_NMDC/07_automation/nmdc_mass_spec_automation/studies/pettridge_11_076c9980_lcms_metab/pettridge_11_076c9980_lcms_metab_config.json")
