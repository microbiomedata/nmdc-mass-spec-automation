#!/usr/bin/env python3
"""
Pett-Ridge study, lcms_metabolomics workflow runner.
Study: Microbial Carbon Transformations in Wet Tropical Soils: Effects of Redox Fluctuation
...
async def main():
    """Run the Pett-Ridge study workflow."""

    # Initialize study manager
    config_path = "studies/pettridge_11_076c9980_lcms_metab/pettridge_11_076c9980_lcms_metab_config.json"
