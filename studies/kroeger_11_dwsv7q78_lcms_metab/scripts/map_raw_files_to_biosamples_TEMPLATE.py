...
python kroeger_11_dwsv7q78/scripts/map_raw_files_to_biosamples_TEMPLATE.py
"""
...
def extract_sample_info_from_filename(filename):
    ...
    # Example patterns to look for in kroeger_11_dwsv7q78:
...
def main():
    ...
    config_path = Path("/Users/heal742/LOCAL/05_NMDC/07_automation/nmdc_mass_spec_automation/studies/kroeger_11_dwsv7q78_lcms_metab/kroeger_lcms_metab_config.json")
