...
if __name__ == "__main__":
    ...
    output_file = ("_emp_500_lcms_metabolomics/metadata/workflow_metadata_batch1_test_202508.json")
    # Start the metadata generation setup
    generator = LCMSMetabolomicsMetadataGenerator(
        metadata_file="/Users/heal742/LOCAL/05_NMDC/02_MetaMS/data_processing/_emp_500_lcms_metabolomics/mapped_raw_data_files_20250812_batch1_test.csv",
