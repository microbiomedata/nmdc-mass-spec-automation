...
class WorkflowMetadataManager:
    ...
    def generate_material_processing_metadata(self, test=False) -> bool:
        ...
        Requires:
        - material_processing/material_processing_outline.yaml
        - material_processing/combined_input.csv (generated by generate_material_processing_input_csv)
        ...
        Example:
            >>> manager = NMDCWorkflowManager('config.json')
            >>> manager.generate_material_processing_input_csv()
