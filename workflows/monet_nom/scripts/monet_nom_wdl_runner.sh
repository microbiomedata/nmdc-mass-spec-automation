...
# WDL Runner Script for monet_nom
# Generated automatically by NMDC Study Manager

# Base directory for the JSON files
BASE_DIR="/home/bmeluch/NMDC/nmdc-mass-spec-automation/workflows/monet_nom/wdl_jsons"

# Count total batch files
NUM_BATCHES=$(find "${BASE_DIR}" -type f -name '*.json' | wc -l)

echo "Found $NUM_BATCHES JSON files to process for study: monet_nom"
...
echo "  Study: monet_nom (['nmdc:sty-11-srtxhh77'])"
