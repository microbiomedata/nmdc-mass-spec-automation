...
# WDL Runner Script for monet_nom_batch_1
# Generated automatically by NMDC Study Manager

# Base directory for the JSON files
BASE_DIR="/home/bmeluch/NMDC/nmdc-mass-spec-automation/workflows/monet_nom_batch_1/wdl_jsons"

# Count total batch files
NUM_BATCHES=$(find "${BASE_DIR}" -type f -name '*.json' | wc -l)

echo "Found $NUM_BATCHES JSON files to process for study: monet_nom_batch_1"
echo "Study ID: ['nmdc:sty-11-srtxhh77']"
echo "========================"
...
echo "  Study: monet_nom_batch_1 (['nmdc:sty-11-srtxhh77'])"
