...
# WDL Runner Script for miesel_11_8bjf2432
# Generated automatically by NMDC Study Manager

# Base directory for the JSON files
BASE_DIR="/home/bmeluch/NMDC/nmdc-mass-spec-automation/workflows/miesel_11_8bjf2432_nom/wdl_jsons"

# Count total batch files
NUM_BATCHES=$(find "${BASE_DIR}" -type f -name '*.json' | wc -l)

echo "Found $NUM_BATCHES JSON files to process for study: miesel_11_8bjf2432"
echo "Study ID: nmdc:sty-11-8bjf2432"
echo "========================"

# Check if WDL file exists in current directory
WDL_FILE="wdl/enviroMS_di_nom.wdl"
if [ ! -f "$WDL_FILE" ]; then
...
echo "  Study: miesel_11_8bjf2432 (nmdc:sty-11-8bjf2432)"
