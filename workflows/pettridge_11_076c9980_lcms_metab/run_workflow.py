...
async def main():
    """Run the Pett Ridge LCMS Metabolomics workflow."""

    # Initialize study manager
    config_path = "workflows/pettridge_11_076c9980_lcms_metab/pettridge_11_076c9980_lcms_metab_config.json"
