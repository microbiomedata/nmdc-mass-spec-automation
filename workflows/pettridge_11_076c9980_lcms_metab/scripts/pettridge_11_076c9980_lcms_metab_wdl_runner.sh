...
# WDL Runner Script for pettridge_11_076c9980
# Generated automatically by NMDC Study Manager

# Base directory for the JSON files
BASE_DIR="/Users/heal742/LOCAL/05_NMDC/07_automation/nmdc_mass_spec_automation/workflows/pettridge_11_076c9980_lcms_metab/wdl_jsons"

# Count total batch files
NUM_BATCHES=$(find "${BASE_DIR}" -type f -name '*.json' | wc -l)

echo "Found $NUM_BATCHES JSON files to process for study: pettridge_11_076c9980"
echo "Study ID: nmdc:sty-11-076c9980"
echo "========================"
...
echo "  Study: pettridge_11_076c9980 (nmdc:sty-11-076c9980)"
