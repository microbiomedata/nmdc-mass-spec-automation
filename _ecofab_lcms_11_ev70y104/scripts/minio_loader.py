...
if __name__ == '__main__':
    ...
    folder_name = "ecofab_11_ev70y104/processed_20251022"  # Specify the folder name within the bucket
    directory = "/Users/heal742/LOCAL/staging_processed/processed_ecofab"
