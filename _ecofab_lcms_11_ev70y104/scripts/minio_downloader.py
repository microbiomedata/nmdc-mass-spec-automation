...
if __name__ == '__main__':
    ...
    folder_name = "ecofab_11_ev70y104/raw"  # Specify the folder name within the bucket (empty string for root)
    local_directory = "/Volumes/LaCie/nmdc_data/_ecofab_11_ev70y104/raw"  # Local destination directory
